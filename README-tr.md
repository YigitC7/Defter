...
<a href="https://github.com/YigitC7/Defter/releases/download/4.0/Defter.exe" title="indir">Windows versiyonu.</a> Yazdığınız notlar Benim geliştirdiğim şifreli bir veri tabanında tutulur. Bu veri tabanı kullanıcı klasöründe .defter içinde bulunur.
...
<summary>Kaldırmak İçin;</summary>
